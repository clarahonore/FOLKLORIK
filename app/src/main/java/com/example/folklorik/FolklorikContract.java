...
public final class FolklorikContract {
    ...
    public static class Folklorik implements BaseColumns {
        ...
        public static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + Folklorik.TABLE_NAME + " (" +
                    Folklorik._ID + " INTEGER PRIMARY KEY," +
                    Folklorik.COLUMN_NAME_NOM_SCENARIO + " TEXT," +
                    Folklorik.COLUMN_NAME_DESCRIPTION_SCENARIO + " TEXT," +
                    Folklorik.COLUMN_NAME_AUDIO_ID + " TEXT)";

        public static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + Folklorik.TABLE_NAME;
